$(document).ready(function () {
    ...
    //5. TAB activity
    let tagText = $('.activity__tags .tag');
    let tagList = $('.activity__list');
    tagText.click(function (item, index) {
        ...
        $('document').click('.activity__list-' + tagID).addClass('active');
    })
...
//EVENTS
    let $parallax = $('.parallax-container section section');
    $parallax.flickity( {
        cellAlign: 'left',
        contain: true,
        freeScroll: true,
